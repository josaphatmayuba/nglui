...
function ensureKeyframes() {
  ...
  styleEl.textContent = "@keyframes nglui-skeleton-pulse { 0%, 100% { opacity: 1; } 50% { opacity: 0.5; } }";
  document.head.appendChild(styleEl);
}

export function Skeleton({ width = "100%", height = "16px", style, ...rest }: SkeletonProps) {
